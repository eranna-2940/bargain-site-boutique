    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data !== "Fail" && res.data !== "Error") {
          setFilteredProducts(res.data.filter((item)=>item.rejectedReason === null && item.accepted_by_admin === "false"));
        }
      })
      ...
      <nav className="navbar navbar-expand-md navbar-light bg-light  d-md-flex justify-content-between">
       ...
       <button
        ...
        <div class="offcanvas offcanvas-start w-75" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
          ...
          <div class="offcanvas-body d-md-flex justify-content-around">
